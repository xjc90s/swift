...
suite.test("append(elementCount:initializingWith:)")
.require(.stdlib_6_4).code {
  let capacity = 4
  var a = ContiguousArray<Int>()
  a.append(addingCapacity: capacity) { span in
    span.append(elementCount: capacity) { rawSpan in
      for i in 0..<capacity {
...
suite.test("append(elementCount:initializingWith:) partial initialization")
.require(.stdlib_6_4).code {
  let capacity = 4
  var a = ContiguousArray<Int>()
  a.append(addingCapacity: capacity) { span in
...
suite.test("append(elementCount:initializingWith:) partial fill throws")
.require(.stdlib_6_4).code {
  var a = ContiguousArray<Int32>()
  try! a.append(addingCapacity: 4) {
    do throws(MyTestError) {
      try $0.append(elementCount: 4) {
...
suite.test("append(elementCount:initializingWith:) appends to existing")
.require(.stdlib_6_4).code {
  var a = ContiguousArray([10, 20])
  a.append(addingCapacity: 4) { span in
    span.append(elementCount: 2) { rawSpan in
...
suite.test("append(elementCount:initializingWith:) negative count")
.skip(.wasiAny(reason: "Trap tests aren't supported on WASI."))
.require(.stdlib_6_4).code {
  var a = ContiguousArray<Int>()
  a.append(addingCapacity: 4) { span in
    expectCrashLater()
    span.append(elementCount: -1) { rawSpan in }
    expectUnreachable("OutputSpan.append should have trapped.")
  }
}

suite.test("append(elementCount:initializingWith:) traps on capacity overflow")
.skip(.wasiAny(reason: "Trap tests aren't supported on WASI."))
.require(.stdlib_6_4).code {
  var a = ContiguousArray<Int>()
  a.append(addingCapacity: 2) { span in
    expectCrashLater()
    span.append(elementCount: 3) { rawSpan in
      for i in 0..<3 {
        rawSpan.append(i, as: Int.self)
      }
    }
